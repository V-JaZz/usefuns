...
class ViewFeaturedPost extends StatefulWidget {
  final int index;
  const ViewFeaturedPost({super.key, required this.index});

  @override
  State<ViewFeaturedPost> createState() => _ViewFeaturedPostState();
}
